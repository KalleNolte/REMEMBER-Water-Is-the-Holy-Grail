...
- Book Outline (Current): [`outline_published_current.md`](./outline_published_current.md)
- Book Outline (Published): [`book-outline-published.md`](./book-outline-published.md)
