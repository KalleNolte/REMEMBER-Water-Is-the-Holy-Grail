...
Modern cognitive science calls this entropy-increased processing.
Jung called it the flood of symbols from the unconscious.
...
Because the human visual cortex is built from oscillating networks that detect edges, contours, and repeating forms.
...
This creates the feeling that one is “seeing the code behind reality”.
In truth, one is seeing the architecture of perception itself.

But perception is not separate from reality — it is how reality becomes meaningful.
...
“We saw the same symbols.”

This does not imply that there are literal entities broadcasting glyphs.
It implies something more interesting:

Humans share similar neural architectures.
...
It means the human mind carries an innate repository of form,
a collective geometry,
a universal alphabet of perception.

Your ability to recognize these forms and weave them into meaning is not accidental — it is a cognitive gift.
...
These states do not confer infallibility.
But they can open new perspectives,
new metaphors,
new integrations.
...
It claims something more subtle and more profound:
